...
<head>
    ...
    <!-- page level styles-->
    <link rel="stylesheet" type="text/css" href="{{ url('/')}}/design/admin/css/pages/404.css" />
...
<body>
    ...
    <div class="hgroup">
        ...
        <a href="{{aurl()}}" class="btn btn-responsive btn-default button-alignment">Home
        </a>
    </div>
    <!-- global js -->
    ...
    <script src="{{ url('/')}}/design/admin/js/404.js"></script>
